...
export const DOCUMENT_TABLE_MAP: DocumentTypeMapEntry[] = [
  ...
  },
  {
    ...
    promoteRpcs: ["promote_verified_fact", "promote_knowledge_chunk_from_fact"],
    targetTables: ["solicitation_addenda", "requirements", "pricing_lines"],
    expectedFields: ["solicitation_number", "requirement", "requested_rate", "addendum_number"],
    status: "schema_ready",
    notes: "solicitation_addenda live; no discrete addendum PDF in USABLE corpus yet.",
  },
  {
  ...
  },
  {
    ...
    status: "partial",
    notes: "Class C contracts verify for schema coverage; do not label as L&P history.",
  },
  {
