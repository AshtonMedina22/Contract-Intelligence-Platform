...
const migration = join(
  import.meta.dirname,
  "../supabase/migrations/20260820710000_verify5_competitor_pricing_sourced.sql",
);
...
process.exit(
  run(
    [
      "-c",
      "select conname from pg_constraint where conname = 'competitor_pricing_lines_has_source';",
    ],
    "check constraint",
  ),
);
