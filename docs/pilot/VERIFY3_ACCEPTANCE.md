...
| pdf | digital PDF parses (SRC-02) | **PASS** | pages=13 193ms |
...
| pdf | real pilot PDF registers in evidence vault (SRC-02) | **PASS** | 1651ms sha=44497b51d423… |
| package | package grouping links multiple pilot docs | **PASS** | package=d65ffdcd docs=2 |
| dedupe | identical SHA-256 does not create new version rows (count stays 1) | **PASS** | versions_with_sha=1 upload_attempt_err=n/a |
| versions | different pilot PDF creates separate version/document | **PASS** | doc1=d353965a doc2=fff059bb |
| intake | SRC-03 Allen packet within 50 MB intake limit | **PASS** | 31.1 MB / 50 MB |
| pdf | large pilot PDF registers (SRC-03) | **PASS** | 106006ms 31.1MB |
...
| provenance | HUMAN_VERIFIED promote succeeds with source_page provenance | **PASS** | {"ok":true,"rate":32.28,"truth":"awarded","action":"rate","rate_type":"standard","labor_category":"Armed officer","pricing_line_id":"fac7479a-bebc-4b3e-bc4d-82777497ef3f"} |
| provenance | provenance survives to canonical pricing_lines | **PASS** | source_fact=006c932b page=3 |
| trust | unresolved rate conflict cannot silently promote overwrite | **PASS** | {"ok":false,"truth":"awarded","action":"conflict","existing":32.28,"incoming":40,"pricing_line_id":"fac7479a-bebc-4b3e-bc4d-82777497ef3f"} |
...
| parse:SRC-02 | 193 |
| register:Allen_ISD_LP_security_agreement_excerpt.pdf | 1651 |
| register:12.pdf | 587 |
| register:1770_43.35658_Services_Contract_with_proposal_Final.pdf | 17180 |
| register:5-21_AllenISD.pdf | 105990 |
| register:bulk-12.pdf | 608 |
| processor:health | 13 |
