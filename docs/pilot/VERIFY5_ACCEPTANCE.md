...
| buyer | Buyer history connects multiple pursuits | **PASS** | opps=2 | Westside ISD mt3a2z97 |
| buyer | Buyer history connects multiple contracts | **FAIL** | contracts=0 | Westside ISD mt3a2z97 |
| buyer | Buyer award links to pursuit under same buyer | **PASS** | [{"id":"f9aba341-bb0a-48d4-bdd4-e77561d99031","opportunity_id":"32b96766-2b8f-4bbe-975f-4e9494832dc5"}] | awards |
| competitor | Sourced competitor bid promotes | **PASS** | {"ok":true,"action":"competitor","competitor_id":"8858ef19-a0b1-44a8-af66-715cf2551173"} | competitor_bids |
...
| competitor | competitor pricing is sourced | **PASS** | unsourced rejected; sourced={"id":"50c72fd0-52e2-4926-b4ae-3f3cda1638a0","source_fact_id":"111ff19c-56b3-4265-8944-9beca8d64de7","source_document_id":"b6020170-cfab-4c63-9eb5-755740747bf7","hourly_rate":18.75} | competitor_pricing_lines |
| scores | ranks/scores match source records | **PASS** | {"scoreRows":[{"respondent_name":"Acme Guard mt3a2z97","points":91,"max_points":100,"rank":1},{"respondent_name":"L&P Global","points":82,"max_points":100,"rank":2}],"bidRank":{"rank":1,"quoted_amount":98000}} | evaluation_scores + competitor_bids.rank |
...
| content | verified fact becomes knowledge chunk | **PASS** | {"ok":true,"action":"chunked","reuse_status":"REVIEW_REQUIRED"} | promote_knowledge_chunk_from_fact |
...
| content | LOST does not automatically equal DO_NOT_USE | **FAIL** | {"outcome":"LOST","reuse":"REVIEW_REQUIRED"} | win_loss vs document_chunks.reuse_status |
...
| research | public facts retain provenance | **PASS** | {"source_url":"https://example.com/board-minutes-westside","client_id":"f4e33bd1-b2f8-4700-8fb4-e8a61058d537","opportunity_id":"32b96766-2b8f-4bbe-975f-4e9494832dc5","source_document_id":"f6cde887-3703-4834-88ab-4ef71db0 | research_facts |
| pursuit | current Pursuit can consume relevant intelligence | **PASS** | {"outcome":"WON","bids":1,"scores":2,"researchCount":1,"award":"f9aba341-bb0a-48d4-bdd4-e77561d99031"} | opportunity 32b96766-2b8f-4bbe-975f-4e9494832dc5 |
